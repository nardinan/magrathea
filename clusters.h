 ...
 */
#ifndef magrathea_clusters_h
#define magrathea_clusters_h
#include <limits.h>
#include <dirent.h>
#include <errno.h>
#include <sys/stat.h>
...
extern int f_clusters_save(struct s_event_environment *environment, int counter, int event, int ladder, time_t timestamp_seconds, short timestamp_mseconds,
		FILE *stream);
