...
struct s_device v_initialized_devices[] = {
	{0x00, "TRB board #1",
		(t_device_call[]){NULL, &f_trb_device_description, &f_trb_device_status, &f_trb_device_stream, &f_trb_device_write, NULL, &f_trb_device_mask,
			&f_trb_device_focus, &f_trb_device_view, &f_trb_device_convert},
	...
	{0xaa, "Trigger board",
		(t_device_call[]){&f_trigger_device_trigger, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
		(t_device_call_generic[]){NULL, &f_trigger_device_initialize, &f_trigger_device_destroy},
		NULL
	},
	{0xbb, "LVDS board",
		(t_device_call[]){NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
